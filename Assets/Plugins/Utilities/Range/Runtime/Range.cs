...
public struct Range {
	...
	/// <summary>
	/// Interpolates the range by the value.
	/// </summary>
	/// <param name="value">the interpolation value between the range.</param>
	/// <returns>the interpolated float result between the range.</returns>
	/// <example>
	/// range.Lerp(0f)   // Returns the smallest value in the range
	/// range.Lerp(1f)   // Returns the largest value in the range
	/// range.Lerp(0.5f) // Returns the midpoint of the two limits of the range
	/// </example>
